...
OLED1_PLATFORM_NUMBER = "2"  # Platform number to show departures for. Note: string not an integer.
OLED2_PLATFORM_NUMBER = "1"  # Platform number to show departures for. Note: string not an integer.
